...
**日期:** 2026-07-29 (修正版)
**状态:** 生效
**适用范围:** 所有 Phase 2–13 的代码实现（Phase 7 及以后的路线由 2026-09-16 路线重新基线
确定，见 `MASTER_PLAN.md` 与 `DECISIONS.md` ADR-015；本次同步只更新 future phase 引用，
架构规则本体未变）
...
4. **RAG / 语义检索 / 向量检索 / MCP / 外部服务边界不适用本条门槛**，因为它们**不要求** Agent 行为。
   它们各自按自身的产品 / 工程理由**独立评估**，且均**不是**路线图的强制交付物：
